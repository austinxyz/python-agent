      ...
      <form @submit.prevent="onSubmit" class="flex flex-col gap-3">
        ...
        <template v-if="showGoogle">
          ...
          <button
            ...
            class="h-[40px] rounded-md text-[13px] font-medium bg-notion-canvas border border-notion-hairline-strong text-notion-charcoal hover:bg-notion-surface flex items-center justify-center gap-2"
          >
